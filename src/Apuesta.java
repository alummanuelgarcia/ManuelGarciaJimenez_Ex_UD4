...
public class Apuesta extends javax.swing.JFrame {
   ...
   /**
    * Método sin parámetros para inicializar la aplicacion
    */
    public Apuesta() 
    {
        initComponents();
   ...
   /**
    * Método que hace la cuenta de los dos numeros aleatorios
    ...
    */
    ...
    /**
     * Método que nos indica cual es el partido de la apuesta
     * @param partido Partido sobre el que se hace la apuesta
     */
    ...
    /**
     * Metodo para eliminar el partido sobre el que se va a hacer la apuesta 
     * @param indice Todos los partidos
     */
